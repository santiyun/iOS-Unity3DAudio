...
namespace TTTRtcEngine
{
	...
	public class IRtcEngineVoice
	{
	#region DllImport
		#if UNITY_STANDALONE_WIN || UNITY_EDITOR
		public const string MyLibName = "TTTRtcEngineVoice";
		#else
		#if UNITY_IPHONE
	...
	#region Engine callbacks
		...
		private IRtcEngineVoice(string appId) {
			createEngine (appId);
		}
		...
		*/
		...
		// 获取/创建引擎实例
		public static IRtcEngineVoice GetEngine (string appId)
		{
			if (instance == null) {
				instance = new IRtcEngineVoice (appId);
			}
			return instance;
		}
		...
		// 查询引擎实例
		public static IRtcEngineVoice QueryEngine()
		{
			return instance;
		}

		private static IRtcEngineVoice instance = null;
